...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {
                        ...
                        LAT_PID_KP_BP: Param([5., 15., 35.], [list, float, int], live=True, depends_on=SHOW_PID_PARAMS),
                        LAT_PID_KP_V: Param([0.04, 0.29, 0.29], [list, float, int], live=True, depends_on=SHOW_PID_PARAMS),
                        LAT_PID_KI_BP: Param([10., 15., 35], [list, float, int], live=True, depends_on=SHOW_PID_PARAMS),
                        LAT_PID_KI_V: Param([0.016, 0.07, 0.07], [list, float, int], live=True, depends_on=SHOW_PID_PARAMS),
                        LAT_PID_KF: Param(6e-6, VT.number, live=True, depends_on=SHOW_PID_PARAMS),
                        SHOW_INDI_PARAMS: Param(False, [bool], live=True),
                        INDI_INNER_GAIN_BP: Param([20, 24, 30], [list, float, int], live=True, depends_on=SHOW_INDI_PARAMS),
                        INDI_INNER_GAIN_V: Param([7.25, 7.5, 9], [list, float, int], live=True, depends_on=SHOW_INDI_PARAMS),
                        INDI_OUTER_GAIN_BP: Param([20, 24, 30], [list, float, int], live=True, depends_on=SHOW_INDI_PARAMS),
                        INDI_OUTER_GAIN_V: Param([6, 7.25, 6], [list, float, int], live=True, depends_on=SHOW_INDI_PARAMS),
                        INDI_TIME_CONSTANT_BP: Param([20, 24], [list, float, int], live=True, depends_on=SHOW_INDI_PARAMS),
                        INDI_TIME_CONSTANT_V: Param([1.6, 1.83], [list, float, int], live=True, depends_on=SHOW_INDI_PARAMS),
                        INDI_ACTUATOR_EFFECTIVENESS_BP: Param([0, 24], [list, float, int], live=True, depends_on=SHOW_INDI_PARAMS),
                        INDI_ACTUATOR_EFFECTIVENESS_V: Param([2, 3], [list, float, int], live=True, depends_on=SHOW_INDI_PARAMS),
