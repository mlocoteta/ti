...
from selfdrive.car.honda.values import CAR, DBC, STEER_THRESHOLD, HONDA_BOSCH, HONDA_NIDEC_ALT_SCM_MESSAGES, HONDA_BOSCH_ALT_BRAKE_SIGNAL, HONDA_BOSCH_RADARLESS, SERIAL_STEERING, TI_STATE, LKAS_LIMITS
...
def get_can_signals(CP, gearbox_msg, main_on_sig_msg):
  ...
  #if True:#CP.enableTorqueInterceptor: #not sure why this isn't detected in time
  signals += [
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam, cp_body):
    ...
    ret.cruiseState.available = True#bool(cp.vl[self.main_on_sig_msg]["MAIN_ON"]) #need to fix this
