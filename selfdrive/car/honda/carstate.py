...
from selfdrive.car.honda.values import CAR, DBC, STEER_THRESHOLD, HONDA_BOSCH, HONDA_NIDEC_ALT_SCM_MESSAGES, HONDA_BOSCH_ALT_BRAKE_SIGNAL, SERIAL_STEERING, LKAS_LIMITS, TI_STATE
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam, cp_body):
    ...
    if self.CP.enableGasInterceptor:
      ...
      ret.gasPressed = user_gas > 20 or (self.ti_ramp_down) or (self.ti_state != 3)
    else:
