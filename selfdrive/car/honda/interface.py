...
#        ret.lateralTuning.init('indi')
      ...
      ret.lateralTuning.init('indi')
      ret.lateralTuning.indi.innerLoopGainBP = [0., 35]
      ret.lateralTuning.indi.innerLoopGainV = [5.555, 9.036]
      ret.lateralTuning.indi.outerLoopGainBP = [0., 35]
      ret.lateralTuning.indi.outerLoopGainV = [4.167, 6.78]
      ret.lateralTuning.indi.timeConstantBP = [0, 35]
      ret.lateralTuning.indi.timeConstantV = [0.8, 0.8]
      ret.lateralTuning.indi.actuatorEffectivenessBP = [0, 35]
      ret.lateralTuning.indi.actuatorEffectivenessV = [13.334, 2.882]
