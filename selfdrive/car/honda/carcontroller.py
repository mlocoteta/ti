...
from selfdrive.car import create_gas_interceptor_command, apply_std_steer_torque_limits, apply_ti_steer_torque_limits, wiggle
...
from common.op_params import opParams, ENABLE_RATE_PARAMS, TI_HIGH_BP, TI_STEER_MAX, TI_STEER_DELTA_UP, TI_STEER_DELTA_DOWN, STOCK_DELTA_UP, STOCK_DELTA_DOWN, STOCK_STEER_MAX, TI_JUMPING_POINT
...
class CarController():
  ...
  def update(self, enabled, active, CS, frame, actuators, pcm_cancel_cmd,
    ...
    if CS.CP.enableTorqueInterceptor:
      ...
      if apply_steer_ti > 0:
        apply_steer_ti = apply_steer_ti + LKAS_LIMITS.TI_JUMPING_POINT
      else:
        apply_steer_ti = apply_steer_ti - LKAS_LIMITS.TI_JUMPING_POINT
